...
namespace SpaceCowboy.SpaceCowboyCode.Cards;
...
/// </summary>
[Pool(typeof(SpaceCowboyCardPool))]
public abstract class SpaceCowboyCard(int cost, CardType type, CardRarity rarity, TargetType target) :
